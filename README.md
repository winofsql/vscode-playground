...
3. 文字列のすべての出現箇所にカーソルを作成する - 文字列である 1 つのインスタンスを選択してください。 例えば、`background-color` を選択して <img style='vertical-align:bottom' src="https://user-images.githubusercontent.com/1501327/163927117-63ce47bc-744b-47af-a460-c36317d129d5.png">
